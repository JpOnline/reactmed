...
var G__15680 = devtools.prefs.pref.call(null,v);
v = G__15680;
continue;
} else {
return v;
...
}catch (e15683){var _e__14692__auto__ = e15683;
return false;
}})();
...
}catch (e15687){var _e__14692__auto__ = e15687;
return false;
}})();
...
}catch (e15689){var _e__14692__auto__ = e15689;
return false;
}}
}
});
...
var vec__15691 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__15691,(0),null);
var name = cljs.core.nth.call(null,vec__15691,(1),null);
...
return cljs.core.some.call(null,(function (p1__15694_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15694_SHARP_);
}),template);
});
