...
var G__15740 = devtools.prefs.pref.call(null,v);
v = G__15740;
continue;
} else {
return v;
...
}catch (e15743){var _e__14752__auto__ = e15743;
return false;
}})();
...
}catch (e15747){var _e__14752__auto__ = e15747;
return false;
}})();
...
}catch (e15749){var _e__14752__auto__ = e15749;
return false;
}}
}
});
...
var vec__15751 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__15751,(0),null);
var name = cljs.core.nth.call(null,vec__15751,(1),null);
...
return cljs.core.some.call(null,(function (p1__15754_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15754_SHARP_);
}),template);
});
