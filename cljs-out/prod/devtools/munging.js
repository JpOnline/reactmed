...
var o15635 = temp__5733__auto__;
var temp__5733__auto____$1 = (o15635["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o15636 = temp__5733__auto____$1;
return (o15636["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__14745__auto__ = f;
return (o__14745__auto__["toString"]).call(o__14745__auto__);
} else {
return "";
}
}catch (e15637){var _ = e15637;
return "";
}});
...
try{var o__14745__auto___15639 = t;
(o__14745__auto___15639["cljs$lang$ctorPrWriter"]).call(o__14745__auto___15639,t,writer);
}catch (e15638){var __15640 = e15638;
}
...
var char_code = (function (){var o__14745__auto__ = (new String(char$));
return (o__14745__auto__["charCodeAt"]).call(o__14745__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__14745__auto__ = String;
return (o__14745__auto__["fromCharCode"]).call(o__14745__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15641 = num_code;
switch (G__15641) {
case (1):
return (185);
...
var o__14745__auto__ = String;
return (o__14745__auto__["fromCharCode"]).call(o__14745__auto__,superscript_code);
});
/**
...
}catch (e15643){var _e__14752__auto__ = e15643;
return false;
}})())){
...
var vec__15644 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__15644,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o15647 = temp__5733__auto__;
var temp__5733__auto____$1 = (o15647["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o15648 = temp__5733__auto____$1;
return (o15648["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___15655 = arguments.length;
var i__4731__auto___15656 = (0);
while(true){
if((i__4731__auto___15656 < len__4730__auto___15655)){
args__4736__auto__.push((arguments[i__4731__auto___15656]));

var G__15657 = (i__4731__auto___15656 + (1));
i__4731__auto___15656 = G__15657;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15651){
var vec__15652 = p__15651;
var ns_detector = cljs.core.nth.call(null,vec__15652,(0),null);
...
var G__15658 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__15659 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__15658;
remaining_tokens = G__15659;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15649){
var G__15650 = cljs.core.first.call(null,seq15649);
var seq15649__$1 = cljs.core.next.call(null,seq15649);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15650,seq15649__$1);
});
...
var vec__15663 = cljs.core.split_with.call(null,(function (p1__15662_SHARP_){
return cljs.core.not_EQ_.call(null,p1__15662_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__15663,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__15663,(1),null);
...
var vec__15669 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__15669,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__15669,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__15672 = cljs.core.rest.call(null,remaining_tokens);
var G__15673 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__15672;
name_tokens = G__15673;
continue;
} else {
...
var vec__15676 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__15676,(0),null);
var arity = cljs.core.nth.call(null,vec__15676,(1),null);
var vec__15679 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__15679,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__15679,(1),null);
var vec__15682 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__15682,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__15682,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__15682,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__15682,(3),null);
...
var vec__15688 = result;
var munged_ns = cljs.core.nth.call(null,vec__15688,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__15688,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__15688,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__15688,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__15688,(4),null);
var arity = cljs.core.nth.call(null,vec__15688,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__15692 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__15692,(0),null);
var args = cljs.core.nth.call(null,vec__15692,(1),null);
var vec__15695 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__15695,(0),null);
var name = cljs.core.nth.call(null,vec__15695,(1),null);
...
var G__15698 = (arity + (1));
var G__15699 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15700){
var vec__15701 = p__15700;
var arity = cljs.core.nth.call(null,vec__15701,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__15701,(1),null);
...
return cljs.core.get.call(null,arities,p1__15704_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__15705_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15708){
var vec__15709 = p__15708;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__15709,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15706){
var G__15707 = cljs.core.first.call(null,seq15706);
var seq15706__$1 = cljs.core.next.call(null,seq15706);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15707,seq15706__$1);
});
...
var G__15715 = arg;
var G__15715__$1 = (((G__15715 instanceof cljs.core.Keyword))?G__15715.fqn:null);
switch (G__15715__$1) {
...
var map__15717 = options;
var map__15717__$1 = (((((!((map__15717 == null))))?(((((map__15717.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15717.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15717):map__15717);
var include_ns_QMARK_ = cljs.core.get.call(null,map__15717__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__15717__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__15717__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__15717__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15718 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__15718,(0),null);
var fn_name = cljs.core.nth.call(null,vec__15718,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__15718,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__15718,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__15718,(4),null);
var arity = cljs.core.nth.call(null,vec__15718,(5),null);
...
var o__14745__auto__ = f;
return (o__14745__auto__["getBasis"]).call(o__14745__auto__);
});
/**
...
}catch (e15722){var _e__14752__auto__ = e15722;
...
var G__15723 = (obj[cljs.core.first.call(null,path)]);
var G__15724 = cljs.core.rest.call(null,path);
obj = G__15723;
path = G__15724;
continue;
} else {
...
return (function (accum,p__15725){
var vec__15726 = p__15725;
var bit = cljs.core.nth.call(null,vec__15726,(0),null);
var protocol = cljs.core.nth.call(null,vec__15726,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15729){
var vec__15730 = p__15729;
var ns = cljs.core.nth.call(null,vec__15730,(0),null);
var name = cljs.core.nth.call(null,vec__15730,(1),null);
var selector = cljs.core.nth.call(null,vec__15730,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__15735,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__15735,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__15735,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__15733_SHARP_){
return (obj[cljs.core.first.call(null,p1__15733_SHARP_)]);
});})(name,sorted_matches,vec__15735,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
